...
bdCon = BoundaryConnectivity(adjcMatrix, colDistM, bdIds, clipVal, geoSigma, true); %% original code

%%
% bdCon = BoundaryConnectivity_v2(adjcMatrix, colDistM, bdIds, clipVal, geoSigma, true); %% revised version
%%
